...
export default function IncomeStatementPage() {
    ...
    const rows: { label: string; key: ISKey; format: 'currency' | 'percent' | 'eps'; bold?: boolean; subheader?: boolean; separator?: boolean }[] = [
        ...
        { label: '', key: 'revenue', format: 'currency', separator: true },
        { label: 'PROFIT APPROPRIATION', key: 'revenue', format: 'currency', subheader: true },
        ...
        { label: 'Net Dividends', key: 'netDividends', format: 'currency' },
        { label: 'Addition to Retained Earnings', key: 'additionToRE', format: 'currency', bold: true },
        { label: '', key: 'revenue', format: 'currency', separator: true },
        { label: 'TAX LOSS CARRYFORWARD', key: 'revenue', format: 'currency', subheader: true },
        { label: 'Carryforward Balance', key: 'taxLossCarryforward', format: 'currency' },
        { label: 'Loss Utilized', key: 'taxLossUtilized', format: 'currency' },
        { label: 'Taxable Income', key: 'taxableIncome', format: 'currency' },
        ...
        { label: 'FCFF', key: 'fcff', format: 'currency', bold: true },
    ];
