...
export async function buildWorkbook(
    ...
    if (liveRates) {
        ...
        addLRRow('CBE Discount Rate', liveRates.cbeDiscountRate, '0.00%', 'Reference rate');
        ...
        addLRRow('Risk-Free Rate', assumptions.riskFreeRate ?? 0.235, '0.00%', '→ Assumptions');
        addLRRow('CBE Rate (Assumptions)', assumptions.cbeRate ?? 0.195, '0.00%', '→ Assumptions tab');
